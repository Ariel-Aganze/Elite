    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">Gestion des marques de produits</p>
        </div>
        <button
          onClick={() => openModal()}
      ...
      <div className="bg-white rounded-xl shadow-card border border-gray-100 overflow-hidden">
        {brands.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Aucune marque</h3>
            <p className="text-gray-500">Commencez par créer votre première marque.</p>
            <button
              onClick={() => openModal()}
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 p-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 flex items-center space-x-2">
                ...
                <span>{editingBrand ? 'Modifier la Marque' : 'Nouvelle Marque'}</span>
              </h3>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <label className="text-sm text-gray-700">Marque active</label>
              </div>
              ...
              <div className="flex items-center space-x-3 pt-4">
                ...
                >
                  ...
                  <span>{saving ? 'Enregistrement...' : editingBrand ? 'Mettre à jour' : 'Créer'}</span>
                </button>
                <button
                  type="button"
                  onClick={() => setShowModal(false)}
